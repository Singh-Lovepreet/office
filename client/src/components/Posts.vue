...
Trending Web Series
-->
<div style="display: flex; flex-direction: row;align-items: center; justify-content: space-between;" id="headings" v-if="recentPosts.length">
...
<span v-if="post.Rating!==0&&post.Rating===1&&post.Rating!==6" style="color:#ec2020;font-weight:600;font-size: 12px;">{{post.Rating}} YAWN</span>
<span v-if="post.Rating!==0&&post.Rating!==1&&post.Rating!==6" style="color:#ec2020;font-weight:600;font-size: 12px;">{{post.Rating}} YAWNS</span>
<span v-if="post.Rating===0" style="color:#ec2020;font-weight:600;font-size: 12px;">YAWNFREE</span>
<span v-if="post.Rating===6" style="color:#ec2020;font-weight:600;font-size: 12px;">Not Yet Rated</span>
</div>
