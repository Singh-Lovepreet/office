...
<p class="heading">All Contents:({{channelData.length}} videos)</p>
</div>
<div class="grid-container">
<md-card class="md-card"  v-for="post in channelData"  v-bind:data="post" :key="post._id">
...
const response = await PostsService.getChannelData({
tokenId:token,
